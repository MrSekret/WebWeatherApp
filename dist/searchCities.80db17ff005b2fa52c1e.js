...
/* harmony import */ var _weatherPage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./weatherPage.js */ "./src/scripts/weatherPage.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var inputElement = document.querySelector('.start-page__inputblock-input');
...
function loadSettings() {
  ...
  if (settingsString.isCitySelected) {
    (0,_weatherPage_js__WEBPACK_IMPORTED_MODULE_1__.loadWeatherPage)(settingsString.currentcity, settingsString.weatherInfo, settingsString.forecastInfo, settingsString.airPollutionInfo);
    (0,_weatherPage_js__WEBPACK_IMPORTED_MODULE_1__.openWeatherPage)();
  }
}
inputElement.addEventListener('input', function (event) {
  var inputValue = event.target.value;
  var newValue = inputValue.charAt(0).toUpperCase() + inputValue.slice(1);
...
function addSelectListners() {
  ...
  cities.forEach(function (cityblock, index) {
    cityblock.addEventListener('click', function () {
      return selectedCity(cityblock);
    });
    cityblock.addEventListener('mouseenter', function () {
      return setCurrentIndex(index);
    });
    cityblock.addEventListener('mouseleave', function () {
      return cityblock.classList.remove('active');
    });
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.requestGeo)(city);
          case 3:
...
function _selectedCity() {
  _selectedCity = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(cityelem) {
    var cities, inputElem, _yield$requestLatLon, _yield$requestLatLon2, lat, lon, weatherInfo, forecastInfo, airPollutionInfo;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 9;
          return (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.requestLatLon)(cityelem.innerHTML.split(",")[0]);
        case 9:
          ...
          _context2.next = 15;
          return (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.requestWeather)([lat, lon]);
        case 15:
          weatherInfo = _context2.sent;
          _context2.next = 18;
          return (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.requestForecast)([lat, lon]);
        case 18:
          forecastInfo = _context2.sent;
          _context2.next = 21;
          return (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.requestAirPollution)([lat, lon]);
        case 21:
          ...
          localStorage.setItem('settings', JSON.stringify(settings));
          (0,_weatherPage_js__WEBPACK_IMPORTED_MODULE_1__.loadWeatherPage)(cityelem.innerHTML, weatherInfo, forecastInfo, airPollutionInfo);
          (0,_weatherPage_js__WEBPACK_IMPORTED_MODULE_1__.openWeatherPage)();
        case 26:
        case "end":
          return _context2.stop();
...
/* harmony export */ });
/* harmony import */ var _searchCities_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./searchCities.js */ "./src/scripts/searchCities.js");

var page = document.querySelector(".page");
var header = document.querySelector(".header");
var startpage = document.querySelector(".start-page");
var weatherpage = document.querySelector(".weather-page");
var weatherPage__previewblock = document.querySelector(".weather-page__previewblock");
var weatherPage__previewblockInfoBg = document.querySelector(".weather-page__previewblock-info-bg");
var weatherPage__topblockTitleblockTitle = document.querySelector(".weather-page__topblock-titleblock-title");
var weatherPage__topblockTitleblockDate = document.querySelector(".weather-page__topblock-titleblock-date");
var weatherPage__topblockTime = document.querySelector(".weather-page__topblock-time");
var weatherPage__botblockDegrees = document.querySelector(".weather-page__botblock-degrees");
var weatherPage__botblockAvgdegrees = document.querySelector(".weather-page__botblock-avgdegrees");
var weatherPage__botblockText = document.querySelector(".weather-page__botblock-text");
var weatherPage__previewblockInfoDecor = document.querySelector(".weather-page__previewblock-info-decor");
var weatherPage__infoblocksToday = document.querySelector(".weather-page__infoblocks-today");
var weatherPage__detailsValue_thermalSensation = document.querySelector(".weather-page__details-value_thermal-sensation");
var weatherPage__detailsValue_visibility = document.querySelector(".weather-page__details-value_visibility");
var weatherPage__detailsValue_windSpeed = document.querySelector(".weather-page__details-value_wind-speed");
var weatherPage__detailsValue_airHumidity = document.querySelector(".weather-page__details-value_air-humidity");
var weatherPage__detailsValue_airPollution = document.querySelector(".weather-page__details-value_airPollution");
var weatherPage__infoblocksNextdays = document.querySelector(".weather-page__infoblocks-nextdays");
var weatherBlocks = document.querySelectorAll(".weather-page__block");
var wrapper = document.querySelector(".wrapper");
var inputElemWeather = document.querySelector(".weather-page__input");
var inputElemStart = document.querySelector('.start-page__inputblock-input');
...
function showStartPage() {
  ...
  (0,_searchCities_js__WEBPACK_IMPORTED_MODULE_0__.showCities)();
}
...
function loadWeatherPage(title, weatherInfo, forecastInfo, airPollutionInfo) {
  ...
  function updateWeatherTime() {
    ...
    var time = dateUTC.toLocaleTimeString('en-US', {
      hour: '2-digit',
      minute: '2-digit',
      hour12: false
    });
  ...
  weatherPage__botblockDegrees.innerHTML = "".concat(temp, "\xBAc");
  weatherPage__botblockAvgdegrees.innerHTML = "".concat(tempmax, "\xBAc / ").concat(tempmin, "\xBAc");
  ...
  if (time[0] == "2" && time[1] > "0") {
    ...
    weatherPage__previewblockInfoBg.src = _weatherPathPNG.substring(0, 13) + "bg_" + _weatherPathPNG.substring(13);
  ...
  weatherPage__detailsValue_thermalSensation.innerHTML = "".concat(feelslike, "\xBAc");
  weatherPage__detailsValue_visibility.innerHTML = "".concat(visibility, " km");
  weatherPage__detailsValue_windSpeed.innerHTML = "".concat(windspeed, " m/s");
  weatherPage__detailsValue_airHumidity.innerHTML = "".concat(humidity, "%");
  weatherPage__detailsValue_airPollution.innerHTML = airPollution;
  for (var ind = 0; ind < weatherBlocks.length; ind++) {
  ...
  function loadForecastNextDay(ind) {
    ...
    var weatherPage__blockTitle = weatherBlocks[ind].querySelector(".weather-page__block-title");
    var weatherPage__blockText = weatherBlocks[ind].querySelector(".weather-page__block-text");
    var weatherPage__blockDegrees = weatherBlocks[ind].querySelector(".weather-page__block-degrees");
    var weatherPage__blockImg = weatherBlocks[ind].querySelector(".weather-page__block-img");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/scripts/searchCities.js");
/******/ 	
/******/ })()
;
//# sourceMappingURL=searchCities.80db17ff005b2fa52c1e.js.map