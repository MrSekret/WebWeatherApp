...
(() => {
/*!********************************************!*\
  !*** ./src/scripts/SearchPage/listners.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _htmlElements_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../htmlElements.js */ "./src/scripts/htmlElements.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.js */ "./src/scripts/SearchPage/index.js");
...
var EraseTimeout;
var currentIndex = -1;
_htmlElements_js__WEBPACK_IMPORTED_MODULE_0__["default"].inputElemStart.addEventListener('input', function (event) {
  var inputValue = event.target.value;
  var newValue = inputValue.charAt(0).toUpperCase() + inputValue.slice(1);
  _htmlElements_js__WEBPACK_IMPORTED_MODULE_0__["default"].inputElemStart.value = newValue;
  clearTimeout(SearchTimeout);
  clearTimeout(EraseTimeout);
  SearchTimeout = setTimeout(_index_js__WEBPACK_IMPORTED_MODULE_1__.showCities, 1500);
  EraseTimeout = setTimeout((0,_index_js__WEBPACK_IMPORTED_MODULE_1__.hideCities)(_htmlElements_js__WEBPACK_IMPORTED_MODULE_0__["default"].inputElemStart.value), 1000);
});
var cities = document.querySelectorAll(".start-page__citiesblock-city");
cities.forEach(function (cityblock, index) {
  cityblock.addEventListener('click', function () {
    return (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.selectedCity)(cityblock);
  });
  cityblock.addEventListener('mouseenter', function () {
    return (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.setCurrentIndex)(index);
  });
  ...
  if (event.key === 'ArrowUp') {
    ...
    cities.forEach(function (cityblock) {
      if (cityblock.classList.contains('active')) {
        (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.selectedCity)(cityblock);
      }
    });
  }
...
/******/ })()
;
//# sourceMappingURL=listnersSearch.1c2c850515aef3f6d7ba.js.map